...
Route::delete('/TvLaidos/{id}', 'TvLaidaController@destoy')->name('tvLaidos.destroy');
...
Route::delete('/Sezonai/{id}', 'SezonaiController@destoy')->name('sezonai.destroy');
...
Route::delete('/Aktoriai/{id}', 'AktoriaiController@destoy')->name('aktoriai.destroy');
...
Route::delete('/Veikejai/{id}', 'VeikejaiController@destoy')->name('veikejai.destroy');
...
Route::delete('/Kurejai/{id}', 'KurejaiController@destoy')->name('kurejai.destroy');
